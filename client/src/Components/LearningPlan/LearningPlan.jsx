...
const LearningPlan = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url('https://t3.ftcdn.net/jpg/07/48/41/96/360_F_748419642_oFo6g3PYLwNP7dpvQCdyWqhMO2a5YjJ3.jpg')`,
    ...
    >
      <div className="p-8" style={{ backgroundColor: 'rgba(255, 255, 255, 0.7)' }}>
        <div className="flex justify-between items-center mb-6">
          <h1 className="learning_plan-header text-4xl font-extrabold text-center">
            My Learning Plans
          </h1>
          <Button
            type="primary"
        ...
        {learningPlan.plans?.length === 0 ? (
          <div 
            className="text-center py-10 border-2 border-dashed rounded-lg hover:border-blue-400 transition-colors"
        ...
        {selectedPlan && (
          <div 
            className="mt-8 border rounded-lg overflow-hidden shadow-sm"
            style={{ backgroundColor: 'rgba(255, 255, 255, 0.8)' }}
          >
            <div className="p-4 border-b bg-gray-50 flex justify-between items-center">
            ...
            <div className="p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="bg-gray-50 p-4 rounded-lg" style={{ backgroundColor: 'rgba(255, 255, 255, 0.7)' }}>
              ...
              {selectedPlan.topics?.length > 0 ? (
                                ...
                                >
                                  <div className="flex items-center">
                                    ...
                                    <a 
                                      ...
                                      className="text-blue-500 hover:underline resource-link"
                                    >
                ...
                <div 
                  className="text-center py-6 border-2 border-dashed rounded-lg hover:border-blue-400 transition-colors"
                  style={{ backgroundColor: 'rgba(255, 255, 255, 0.7)' }}
                >
        ...
        <Modal
          ...
          destroyOnClose
          width={600}
          bodyStyle={{ backgroundColor: 'rgba(255, 255, 255, 0.85)' }}
        >
          <Form 
            form={planForm} 
